...
type HistoryEntry struct {
	...
	// JSON-encoded NotificationConfig for active notifications.
	// Present when the notification still needs user action (inline buttons).
	// Empty for completed notifications.
	ConfigJson    []byte `protobuf:"bytes,8,opt,name=config_json,json=configJson,proto3" json:"config_json,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HistoryEntry) GetConfigJson() []byte {
	if x != nil {
		return x.ConfigJson
	}
	return nil
...
const file_proto_hermes_proto_rawDesc = "" +
	...
	"\arecords\x18\x01 \x03(\v2\x14.hermes.HistoryEntryR\arecords\"\xfc\x01\n" +
	...
	"\x0ecompleted_unix\x18\a \x01(\x03R\rcompletedUnix\x12\x1f\n" +
	"\vconfig_json\x18\b \x01(\fR\n" +
	"configJson\"\x11\n" +
