...
Captured from [`testdata/`](../) configs. Screenshots are generated by the Playwright e2e tests (`go test -tags e2e ./e2e/`) and can be regenerated with `UPDATE_GOLDEN=1`. The [`screenshot.ps1`](screenshot.ps1) script captures from a live Windows desktop.
